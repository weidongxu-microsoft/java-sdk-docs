...
To add an HTTP proxy, follow the guidance in the [proxy configuration](proxying.md) documentation. Be sure to use the default Fiddler address of `localhost` on port 8888.
